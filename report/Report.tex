...
\begin{document}
	...
	\begin{enumerate}
		...
		\item \textbf{Brain Tumor MRI Dataset:} Available at: \href{https://www.kaggle.com/datasets/rishiksaisanthosh/brain-tumour-classification/data}{Kaggle}.
		...
		\item \textbf{Blitz-Bayesian-Pytorch:} Available at: \href{https://github.com/piEsposito/blitz-bayesian-deep-learning}{Github}
	\end{enumerate}
\end{document}