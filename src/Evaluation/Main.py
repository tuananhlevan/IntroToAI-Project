...
MCDropoutCifar10 = MCDropout(num_classes=10)
MCDropoutCifar10.load_state_dict(torch.load("MCDropout/model/CIFAR-10-MCDropout.pth", weights_only=True))
MCDropoutCifar10.to(DEVICE)
MCDropoutCifar10.eval()
...
MCDropoutCifar100 = MCDropout(num_classes=100)
MCDropoutCifar100.load_state_dict(torch.load("MCDropout/model/CIFAR-100-MCDropout.pth", weights_only=True))
MCDropoutCifar100.to(DEVICE)
MCDropoutCifar100.eval()
...
mcDropoutMetrics10, probMcDropout10, _ = evaluate_model(MCDropoutCifar10, DEVICE, 10, c10_test_loader, is_bayesian=True, num_samples=20)
...
mcDropoutMetrics100, probMcDropout100, _ = evaluate_model(MCDropoutCifar100, DEVICE, 100, c100_test_loader, is_bayesian=True, num_samples=20)

results_dict_cifar10 = {
    "Bayesian Hybrid": bayesMetrics10,
    "CNN": cnnMetrics10,
    "MCDropout": mcDropoutMetrics10,
}

results_dict_cifar100 = {
    "Bayesian Hybrid": bayesMetrics100,
    "CNN": cnnMetrics100,
    "MCDropout": mcDropoutMetrics100,
}

reliability_diagram(label10, [probBayes10, probCnn10, probMcDropout10], ["Bayes", "CNN", "MCDropout"], n_bins=15, path="calibration_cifar10")
reliability_diagram(label100, [probBayes100, probCnn100, probMcDropout100], ["Bayes", "CNN", "MCDropout"], n_bins=15, path="calibration_cifar100")
